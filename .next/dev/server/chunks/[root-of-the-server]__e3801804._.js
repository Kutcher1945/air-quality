...
"[project]/app/api/plants-mvt/[z]/[x]/[y]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_req, { params }) {
    ...
    if ([
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]("invalid tile coordinates", {
            status: 400
        });
    }
    ...
    try {
        const { rows } = await client.query(`SELECT ST_AsMVT(tile, 'plants', 4096, 'geom') AS mvt
       FROM (
         SELECT
           ST_AsMVTGeom(
       ...
       WHERE geom IS NOT NULL`, [
        ...
        const mvt = rows[0]?.mvt ?? null;
        if (!mvt || mvt.length === 0) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](null, {
                status: 204
            });
        }
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](new Uint8Array(mvt), {
            headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e3801804._.js.map