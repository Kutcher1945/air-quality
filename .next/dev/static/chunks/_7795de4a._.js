...
"[project]/lib/plantsCache.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$plantsCache$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/plantsCache.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
async function fetchPlantTile(key, limit) {
    const cached = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$plantsCache$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPlantTile"])(key);
    ...
    try {
        ...
        if (features.length > 0) (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$plantsCache$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["savePlantTile"])(key, features);
        return features;
    } catch  {
        return [];
    }
...
function EcoAlmatyMap({ visibleLayers }) {
    ...
    // plant tile refs
    const plantTilesLoaded = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(new Set());
    const plantTilesPending = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(new Set());
    const plantFeatures = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(new Map());
    const plantReady = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    const lastStepRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const [plantCount, setPlantCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    const loadPlantViewport = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "EcoAlmatyMap.useCallback[loadPlantViewport]": async ()=>{
            ...
            const toFetch = keys.filter({
                "EcoAlmatyMap.useCallback[loadPlantViewport].toFetch": (k)=>!plantTilesLoaded.current.has(k) && !plantTilesPending.current.has(k)
            }["EcoAlmatyMap.useCallback[loadPlantViewport].toFetch"]);
            toFetch.forEach({
                "EcoAlmatyMap.useCallback[loadPlantViewport]": (k)=>plantTilesPending.current.add(k)
            }["EcoAlmatyMap.useCallback[loadPlantViewport]"]);
            if (toFetch.length > 0) beginLoad();
            // Immediately render any already-cached viewport tiles
            const updateSource = {
                "EcoAlmatyMap.useCallback[loadPlantViewport].updateSource": ()=>{
                    const src = map.getSource("src-plants");
                    if (!src) return;
                    const viewportSet = new Set(viewportTiles(map.getBounds(), tileParams(map.getZoom()).step));
                    const features = [];
                    plantFeatures.current.forEach({
                        "EcoAlmatyMap.useCallback[loadPlantViewport].updateSource": (feats, k)=>{
            ...
            try {
                for(let i = 0; i < toFetch.length; i += BATCH){
                    ...
                    const results = await Promise.allSettled(batch.map({
                        "EcoAlmatyMap.useCallback[loadPlantViewport]": (k)=>fetchPlantTile(k, limit)
                    }["EcoAlmatyMap.useCallback[loadPlantViewport]"]));
                    let anyNew = false;
                    results.forEach({
                        "EcoAlmatyMap.useCallback[loadPlantViewport]": (r, idx)=>{
                            const key = batch[idx];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EcoAlmatyMap.useEffect": ()=>{
            ...
            if (!map) return;
            const handler = {
                "EcoAlmatyMap.useEffect.handler": ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
          ...
          `
            ...
            visibleLayers.has("plants") && plantCount > 0 && !globalLoading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                style: {
                    position: "absolute",
                    bottom: 36,
                    right: 12,
...
_s(EcoAlmatyMap, "eqKu0vOp1Ys8YOPJWFxwTorqJuw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$themes$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"]
    ];
});
...
//# sourceMappingURL=_7795de4a._.js.map