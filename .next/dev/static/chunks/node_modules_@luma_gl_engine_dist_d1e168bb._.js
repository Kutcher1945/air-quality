...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$animation$2d$loop$2f$request$2d$animation$2d$frame$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/engine/dist/animation-loop/request-animation-frame.js [app-client] (ecmascript)");
...
const defaultAnimationFrameProvider = {
    requestAnimationFrame: (callback)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$animation$2d$loop$2f$request$2d$animation$2d$frame$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["requestAnimationFramePolyfill"])(callback),
    cancelAnimationFrame: (animationFrameId)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$animation$2d$loop$2f$request$2d$animation$2d$frame$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cancelAnimationFramePolyfill"])(animationFrameId)
};
class AnimationLoop {
     ...
     */ constructor(props){
        ...
        this.sharedStats = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$luma$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["luma"].stats.get(ANIMATION_LOOP_STATS);
    ...
    reportError(error) {
        ...
        if (this.props.onError === AnimationLoop.defaultAnimationLoopProps.onError && typeof window !== 'undefined' && typeof ErrorEvent !== 'undefined') {
    ...
    /** Query redraw status. Clears the flag. */ needsRedraw() {
    ...
    /** Explicitly draw a frame */ redraw(time, animationFrame = null) {
...
"[project]/node_modules/@luma.gl/engine/dist/dynamic-buffer/dynamic-buffer.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    ()=>isBufferRangeBinding,
    "isDynamicBufferRange",
    ()=>isDynamicBufferRange,
    "resolveBufferBindingSource",
    ()=>resolveBufferBindingSource,
    "resolveBufferRangeBinding",
    ()=>resolveBufferRangeBinding,
    "resolveDynamicBufferRangeBinding",
    ()=>resolveDynamicBufferRangeBinding
]);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$uid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/engine/dist/utils/uid.js [app-client] (ecmascript)");
;
;
const DEFAULT_MAX_DEBUG_DATA_BYTE_LENGTH = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$buffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].DEBUG_DATA_MAX_LENGTH;
class DynamicBuffer {
    /** Device that owns the backing buffer. */ device;
    /** Application-provided or generated identifier. */ id;
    /** Ready promise provided for compatibility with other dynamic resources. */ ready;
    /** Usage flags applied to every backing buffer created by this wrapper. */ usage;
    /** Normalized buffer props reused when the backing buffer is recreated. */ props;
    /** Dynamic buffers are synchronously ready after construction. */ isReady = true;
    /** Whether {@link destroy} has been called. */ destroyed = false;
    /** Monotonic version that increments whenever the backing buffer is replaced. */ generation = 0;
    /** Last update timestamp for writes, reads that populate debug data, or resize operations. */ updateTimestamp;
    /** Optional CPU-side mirror of recent writes and readbacks for debugging. */ debugData = new ArrayBuffer(0);
    _debugDataEnabled;
    _maxDebugDataByteLength;
    _ownsBuffer;
    _buffer;
    /** Current immutable core buffer backing this dynamic wrapper. */ get buffer() {
        return this._buffer;
    }
    /** Current byte length of the backing buffer. */ get byteLength() {
        return this._buffer.byteLength;
    }
    /** String tag used by `Object.prototype.toString`. */ get [Symbol.toStringTag]() {
        return 'DynamicBuffer';
    }
    /** Human-readable debug string. */ toString() {
    ...
    /** Creates a dynamic buffer and its initial backing {@link Buffer}. */ constructor(device, props){
        ...
        const id = props.id || adoptedBuffer?.id || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$uid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uid"])('dynamic-buffer');
        ...
        if ((normalizedBufferProps.usage || 0) & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$buffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].INDEX && !normalizedBufferProps.indexType) {
        ...
        this._maxDebugDataByteLength = typeof debugDataProps === 'object' && debugDataProps.maxByteLength !== undefined ? debugDataProps.maxByteLength : DEFAULT_MAX_DEBUG_DATA_BYTE_LENGTH;
        this._ownsBuffer = ownsBuffer;
        this._buffer = adoptedBuffer ?? this.device.createBuffer({
            ...bufferProps,
            id
        });
    ...
    /** Destroys the current backing buffer and clears debug data. */ destroy() {
        if (!this.destroyed) {
            if (this._ownsBuffer) {
...
function isDynamicBufferRange(binding) {
...
function resolveDynamicBufferRangeBinding(binding) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$math$2e$gl$2f$types$2f$dist$2f$is$2d$array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@math.gl/types/dist/is-array.js [app-client] (ecmascript)");
;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$model$2f$split$2d$uniforms$2d$and$2d$bindings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/engine/dist/model/split-uniforms-and-bindings.js [app-client] (ecmascript)");
;
;
;
class ShaderInputs {
    ...
    /** Registered shader modules, including resolved dependencies. */ // @ts-ignore Fix typings
    modules;
    /** Stores the uniform values for each module */ moduleUniforms;
    /** Stores resource bindings for each module. */ moduleBindings;
    /** Stores shader resource bindings that are not owned by a shader module. */ directBindings = {};
    ...
    modules, options){
        ...
        const resolvedModules = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$shadertools$2f$dist$2f$lib$2f$shader$2d$module$2f$shader$2d$module$2d$dependencies$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getShaderModuleDependencies"])(Object.values(modules).filter(isShaderInputsModuleWithDependencies));
     ...
     */ setProps(props) {
        ...
        for (const name of Object.keys(props)){
            ...
            if (!module) {
                ...
                const { uniforms, bindings } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$model$2f$split$2d$uniforms$2d$and$2d$bindings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["splitUniformsAndBindings"])(uniformsAndBindings, module.uniformTypes);
    ...
    /** Returns registered shader modules, including resolved dependencies. */ getModules() {
     ...
     */ addModules(modules) {
        const modulesToAdd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$shadertools$2f$dist$2f$lib$2f$shader$2d$module$2f$shader$2d$module$2d$dependencies$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getShaderModuleDependencies"])(modules);
    ...
    /** Merges concrete and deferred bindings for the shader from the registered modules. */ getBindingValues() {
        const bindings = {};
...
"[project]/node_modules/@luma.gl/engine/dist/utils/shader-module-utils.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function mergeShaderModuleBindingsIntoLayout(shaderLayout, modules) {
    ...
    const mergedLayout = {
        ...shaderLayout,
        bindings: shaderLayout.bindings.map((binding)=>({
                ...binding
            }))
    };
...
function getShaderModuleUniformBlockLayouts(modules) {
    ...
    for (const module of modules){
        const defaultUniformBlockName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$shadertools$2f$dist$2f$lib$2f$shader$2d$module$2f$shader$2d$module$2d$uniform$2d$layout$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getShaderModuleUniformBlockName"])(module);
        const std140BlockNames = new Set([
            module.vs,
            module.fs
        ].flatMap((shaderSource)=>shaderSource ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$shadertools$2f$dist$2f$lib$2f$shader$2d$module$2f$shader$2d$module$2d$uniform$2d$layout$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGLSLUniformBlocks"])(shaderSource).filter((block)=>block.isStd140).map((block)=>block.blockName) : []));
        const uniformBlockName = std140BlockNames.has(defaultUniformBlockName) ? defaultUniformBlockName : std140BlockNames.size === 1 ? std140BlockNames.values().next().value : undefined;
        if (shaderModuleHasUniforms(module) && uniformBlockName) {
            uniformBlockLayouts.push({
                name: uniformBlockName,
                uniformTypes: module.uniformTypes
            });
        }
    }
...
/** Returns binding-name aliases that should share the module-declared bind group. */ function getRelatedBindingNames(bindingName) {
    const bindingNames = new Set([
        bindingName,
        `${bindingName}Uniforms`
    ]);
...
function mergeBindingLayouts(explicitBindings, inferredBindings) {
    const mergedBindings = explicitBindings.map((binding)=>({
            ...binding
        }));
...
function mergeAttributeLayouts(explicitAttributes, inferredAttributes) {
    const mergedAttributes = explicitAttributes.map((attribute)=>({
            ...attribute
        }));
    const explicitAttributesByName = new Map(explicitAttributes.map((attribute)=>[
            attribute.name,
            attribute
        ]));
    const explicitAttributesByLocation = new Map(explicitAttributes.map((attribute)=>[
            attribute.location,
            attribute
        ]));
...
"[project]/node_modules/@luma.gl/engine/dist/compute/computation.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$factories$2f$pipeline$2d$factory$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/factories/pipeline-factory.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$factories$2f$shader$2d$factory$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/factories/shader-factory.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$portable$2f$uniform$2d$store$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/portable/uniform-store.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$shadertools$2f$dist$2f$lib$2f$shader$2d$plugin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/shadertools/dist/lib/shader-plugin.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$math$2e$gl$2f$types$2f$dist$2f$is$2d$array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@math.gl/types/dist/is-array.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$shader$2d$inputs$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/engine/dist/shader-inputs.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$shader$2d$module$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/engine/dist/utils/shader-module-utils.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$uid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/engine/dist/utils/uid.js [app-client] (ecmascript)");
;
;
;
...
class Computation {
    static defaultProps = {
        ...
        shaderAssembler: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$shadertools$2f$dist$2f$lib$2f$shader$2d$assembler$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShaderAssembler"].getDefaultShaderAssembler('wgsl'),
    ...
    /** The underlying GPU pipeline. */ pipeline;
    /** Assembled compute shader source */ source;
    /** the underlying compiled compute shader */ // @ts-ignore Set in function called from constructor
    shader;
    /** ShaderInputs instance */ shaderInputs;
    ...
    constructor(device, props){
        ...
        const resolvedPlugins = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$shadertools$2f$dist$2f$lib$2f$shader$2d$plugin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveShaderPlugins"])(this.props.plugins, platformInfo.shaderLanguage);
        ...
        const shaderInputModules = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$shadertools$2f$dist$2f$lib$2f$shader$2d$plugin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeShaderPluginModules"])(this.props.modules, resolvedPlugins.modules);
        const moduleMap = Object.fromEntries(shaderInputModules.map((module)=>[
                module.name,
                module
            ]));
        // @ts-ignore TODO - fix up typing?
        this.shaderInputs = props.shaderInputs || new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$shader$2d$inputs$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShaderInputs"](moduleMap);
        if (props.shaderInputs && resolvedPlugins.modules.length > 0) {
            this.shaderInputs.addModules(resolvedPlugins.modules);
        }
        this.setShaderInputs(this.shaderInputs);
        // Setup shader assembler
        const modules = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$shader$2d$module$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeShaderModules"])(this.props.modules, this.shaderInputs?.getModules());
        const defines = {
            ...resolvedPlugins.defines,
            ...this.props.defines
        };
        this.props.shaderLayout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$shader$2d$module$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeShaderModuleBindingsIntoLayout"])(this.props.shaderLayout, modules) || null;
        this.pipelineFactory = props.pipelineFactory || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$factories$2f$pipeline$2d$factory$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PipelineFactory"].getDefaultPipelineFactory(this.device);
        this.shaderFactory = props.shaderFactory || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$factories$2f$shader$2d$factory$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShaderFactory"].getDefaultShaderFactory(this.device);
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$assert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assert"])(shaderAssembler instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$shadertools$2f$dist$2f$lib$2f$shader$2d$assembler$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WGSLShaderAssembler"]);
        ...
        const inferredShaderLayout = assembledShaderLayout ?? device.getShaderLayout?.(this.source, {
            scanVertexAttributes: false
        });
        this.props.shaderLayout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$shader$2d$module$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeShaderModuleBindingsIntoLayout"])(this.props.shaderLayout || inferredShaderLayout || null, modules) || null;
        // Create the pipeline
    ...
    /** Dispatches a GPU-written workgroup count from an indirect buffer. */ dispatchIndirect(computePass, indirectBuffer, indirectOffset = 0) {
        try {
            this._logDrawCallStart();
            this._setPipeline(computePass);
    ...
    setShaderInputs(shaderInputs) {
        ...
        this._uniformStore = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$portable$2f$uniform$2d$store$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UniformStore"](this.device, this.shaderInputs.modules);
        // Create uniform buffer bindings for all modules
        for (const [moduleName, module] of Object.entries(this.shaderInputs.modules)){
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$shader$2d$module$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shaderModuleHasUniforms"])(module)) {
     ...
     */ setShaderModuleProps(props) {
        ...
        const keys = Object.keys(uniforms).filter((k)=>{
            ...
            return !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$math$2e$gl$2f$types$2f$dist$2f$is$2d$array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNumericArray"])(uniform) && typeof uniform !== 'number' && typeof uniform !== 'boolean';
        });
        const bindings = {};
        for (const k of keys){
    ...
    _getBufferOrConstantValues(attribute, dataType) {
        const TypedArrayConstructor = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$data$2d$types$2f$data$2d$type$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dataTypeDecoder"].getTypedArrayConstructor(dataType);
...
class Geometry {
    /** Application-provided or generated identifier. */ id;
    /** Determines how vertices are assembled into primitives. */ topology;
    /** Resolved draw vertex count. */ vertexCount;
    /** Optional index attribute. */ indices;
    /** CPU attributes, keyed by caller-provided source attribute name. */ attributes;
    /** Buffer layout matching the geometry attributes. Always populated. */ bufferLayout;
    /** Application-owned metadata. */ userData = {};
    /** Creates a CPU geometry and wraps raw typed arrays into attribute records. */ constructor(props){
    ...
    /** Returns the resolved draw vertex count. */ getVertexCount() {
        return this.vertexCount;
    }
    /** Returns all attributes, including `indices` when index data is present. */ getAttributes() {
        return this.indices ? {
...
function getBufferLayoutFromGeometryAttributes(attributes) {
    ...
    for (const [attributeName, attribute] of Object.entries(attributes)){
        ...
        bufferLayout.push({
            ...
            format: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$vertex$2d$types$2f$vertex$2d$format$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vertexFormatDecoder"].getVertexFormatFromAttribute(value, size, normalized)
        });
    }
    return bufferLayout;
} //# sourceMappingURL=geometry.js.map
}),
"[project]/node_modules/@luma.gl/engine/dist/geometry/geometry-utils.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function makeInterleavedGeometry(geometry, options = {}) {
    ...
    for (const [sourceName, attribute] of sourceAttributes){
        ...
        const format = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$vertex$2d$types$2f$vertex$2d$format$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vertexFormatDecoder"].getVertexFormatFromAttribute(value, size, normalized);
        const vertexFormatInfo = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$vertex$2d$types$2f$vertex$2d$format$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vertexFormatDecoder"].getVertexFormatInfo(format);
        byteOffset = alignTo(byteOffset, minAttributeAlignment);
        interleavedAttributes.push({
            sourceName,
            attributeName: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$geometry$2f$geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGeometryShaderAttributeName"])(sourceName),
            value,
            size,
            format,
            byteOffset,
    ...
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$geometry$2f$geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Geometry"]({
        id: geometry.id,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$buffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/adapter/resources/buffer.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$geometry$2f$geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/engine/dist/geometry/geometry.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$geometry$2f$geometry$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/engine/dist/geometry/geometry-utils.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$uid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/engine/dist/utils/uid.js [app-client] (ecmascript)");
;
;
;
...
class GPUGeometry {
    ...
    /** Application-owned metadata. */ userData = {};
    /** Determines how vertices are assembled into primitives. */ topology;
    /** Buffer layout matching {@link GPUGeometry.attributes}. */ bufferLayout = [];
    /** Resolved draw vertex count. */ vertexCount;
    /** Optional GPU index buffer. */ indices;
    /** GPU vertex buffers, keyed by buffer layout name. */ attributes;
    /** Creates GPU-backed geometry from existing buffers. */ constructor(props){
        this.id = props.id || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$uid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uid"])('geometry');
        this.topology = props.topology;
    ...
    /** Destroys the owned index and vertex buffers. */ destroy() {
        this.indices?.destroy();
        for (const attribute of Object.values(this.attributes)){
            attribute.destroy();
        }
    }
    /** Returns the draw vertex count. */ getVertexCount() {
        return this.vertexCount;
    }
    /** Returns the GPU vertex buffers. */ getAttributes() {
        return this.attributes;
    }
    /** Returns the GPU index buffer, or `null` for non-indexed geometry. */ getIndexes() {
...
function makeGPUGeometry(device, geometry) {
    ...
    const sourceGeometry = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$geometry$2f$geometry$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["makeInterleavedGeometry"])(geometry);
...
function getAttributeBuffersFromGeometry(device, geometry) {
    ...
    for (const [attributeName, attribute] of Object.entries(geometry.attributes)){
        const name = geometry.bufferLayout.find((bufferLayout)=>bufferLayout.name === attributeName)?.name || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$geometry$2f$geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGeometryShaderAttributeName"])(attributeName);
        if (attribute) {
...
"[project]/node_modules/@luma.gl/engine/dist/utils/buffer-layout-helper.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class BufferLayoutHelper {
    ...
    /** Get attribute names from a BufferLayout */ getAttributeNamesForBuffer(bufferLayout) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2d$utils$2f$buffer$2d$layout$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBufferLayoutAttributeNames"])(bufferLayout);
    }
...
"[project]/node_modules/@luma.gl/engine/dist/utils/buffer-layout-order.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function sortedBufferLayoutByShaderSourceLocations(shaderLayout, bufferLayout) {
    const shaderLayoutMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2d$utils$2f$buffer$2d$layout$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getShaderAttributeLocationMap"])(shaderLayout);
    const sortedLayout = bufferLayout.slice();
    sortedLayout.sort((a, b)=>{
        const minLocationA = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2d$utils$2f$buffer$2d$layout$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMinimumAttributeLocation"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2d$utils$2f$buffer$2d$layout$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBufferLayoutAttributeNames"])(a).map((attributeName)=>shaderLayoutMap[attributeName]));
        const minLocationB = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2d$utils$2f$buffer$2d$layout$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMinimumAttributeLocation"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2d$utils$2f$buffer$2d$layout$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBufferLayoutAttributeNames"])(b).map((attributeName)=>shaderLayoutMap[attributeName]));
        return minLocationA - minLocationB;
    });
    return sortedLayout;
} //# sourceMappingURL=buffer-layout-order.js.map
}),
"[project]/node_modules/@luma.gl/engine/dist/dynamic-texture/texture-binding-source.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getTextureBindingLayout(shaderLayout, bindingName, options) {
    const bindingLayout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2d$utils$2f$bind$2d$groups$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getShaderLayoutBinding"])(shaderLayout, bindingName, {
        ignoreWarnings: true
    });
...
} //# sourceMappingURL=texture-binding-source.js.map
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$buffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/adapter/resources/buffer.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$external$2d$texture$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/adapter/resources/external-texture.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$shadertools$2f$dist$2f$lib$2f$shader$2d$plugin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/shadertools/dist/lib/shader-plugin.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$shadertools$2f$dist$2f$lib$2f$shader$2d$assembler$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/shadertools/dist/lib/shader-assembler.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$geometry$2f$gpu$2d$geometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/engine/dist/geometry/gpu-geometry.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$debug$2f$debug$2d$shader$2d$layout$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/engine/dist/debug/debug-shader-layout.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$debug$2f$debug$2d$framebuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/engine/dist/debug/debug-framebuffer.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$deep$2d$equal$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/engine/dist/utils/deep-equal.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$buffer$2d$layout$2d$helper$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/engine/dist/utils/buffer-layout-helper.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$buffer$2d$layout$2d$order$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/engine/dist/utils/buffer-layout-order.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$shader$2d$module$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/engine/dist/utils/shader-module-utils.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$uid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/engine/dist/utils/uid.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$shader$2d$inputs$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/engine/dist/shader-inputs.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$dynamic$2d$buffer$2f$dynamic$2d$buffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/engine/dist/dynamic-buffer/dynamic-buffer.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$dynamic$2d$texture$2f$texture$2d$binding$2d$source$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/engine/dist/dynamic-texture/texture-binding-source.js [app-client] (ecmascript)");
;
;
;
;
...
class Model {
    static defaultProps = {
        ...
        shaderAssembler: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$shadertools$2f$dist$2f$lib$2f$shader$2d$assembler$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShaderAssembler"].getDefaultShaderAssembler('glsl'),
        debugShaders: undefined,
        disableWarnings: undefined
    };
    /** Device that created this model */ device;
    /** Application provided identifier */ id;
    /** WGSL shader source when using unified shader */ // @ts-expect-error assigned in function called from constructor
    source;
    /** GLSL vertex shader source */ // @ts-expect-error assigned in function called from constructor
    vs;
    /** GLSL fragment shader source */ // @ts-expect-error assigned in function called from constructor
    fs;
    /** Factory used to create render pipelines */ pipelineFactory;
    /** Factory used to create shaders */ shaderFactory;
    /** User-supplied per-model data */ userData = {};
    ...
    /** Indexed draw count override. Undefined draws the full bound index buffer. */ indexCount;
    /** First vertex byte offset for WebGL indexed draws or first vertex for non-indexed draws. */ firstVertex;
    /** First index element for WebGPU indexed draws. */ firstIndex;
    ...
    constructor(device, props){
        ...
        this.props = {
            ...Model.defaultProps,
            ...props,
            shaderAssembler: props.shaderAssembler ?? (isShaderAssemblerForLanguage(defaultShaderAssembler, device.info.shadingLanguage) ? defaultShaderAssembler : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$shadertools$2f$dist$2f$lib$2f$shader$2d$assembler$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShaderAssembler"].getDefaultShaderAssembler(device.info.shadingLanguage))
        };
        props = this.props;
        this.id = props.id || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$uid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uid"])('model');
        this.device = device;
        ...
        // Setup shader assembler
        const modules = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$shader$2d$module$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeShaderModules"])(this.props.modules, shaderInputs.getModules());
        const defines = {
            ...resolvedPlugins.defines,
            ...this.props.defines
        };
        if (this.device.type === 'webgl') {
            this.props._uniformBlockLayouts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$shader$2d$module$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getShaderModuleUniformBlockLayouts"])(modules);
        }
        this.props.shaderLayout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$shader$2d$module$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeShaderModuleBindingsIntoLayout"])(this.props.shaderLayout, modules) || null;
        ...
        if (isWebGPU && this.props.source) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$assert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assert"])(isShaderAssemblerForLanguage(shaderAssembler, 'wgsl'));
            ...
            const scannedOrReflectedShaderLayout = assembledShaderLayout ?? device.getShaderLayout?.(this.source);
            ...
            const shaderLayout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$shader$2d$module$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeInferredShaderLayout"])(this.props.shaderLayout, inferredShaderLayout, Object.keys(resolvedPlugins.vertexInputs));
            this.props.shaderLayout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$shader$2d$module$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeShaderModuleBindingsIntoLayout"])(shaderLayout || null, modules) || null;
        } else {
            // GLSL
            const shaderAssembler = this.props.shaderAssembler;
            // GLSL shader pairs require an assembler with GLSL-specific hooks.
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$assert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assert"])(isShaderAssemblerForLanguage(shaderAssembler, 'glsl'));
    ...
    /** Returns WGSL binding debug rows for the assembled shader. Returns an empty array for GLSL models. */ getBindingDebugTable() {
     ...
     */ draw(renderPass) {
        if (this._drawBlockedReason && !this._pipelineNeedsUpdate) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].info(LOG_DRAW_PRIORITY, `>>> DRAWING ABORTED ${this.id}: ${this._drawBlockedReason}`)();
            return false;
        }
        ...
        try {
            ...
            if (pipelineErrored) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].info(LOG_DRAW_PRIORITY, `>>> DRAWING ABORTED ${this.id}: ${PIPELINE_INITIALIZATION_FAILED}`)();
                drawSuccess = false;
            } else {
                const drawValidationError = this.vertexArray.getDrawValidationError();
                if (drawValidationError) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].info(LOG_DRAW_PRIORITY, `>>> DRAWING ABORTED ${this.id}: ${drawValidationError}`)();
                    ...
                    const indexCount = indexBuffer ? this.indexCount ?? indexBuffer.byteLength / (indexBuffer.indexType === 'uint32' ? 4 : 2) : undefined;
     ...
     */ setGeometry(geometry) {
        ...
        if (gpuGeometry) {
            ...
            const bufferLayoutHelper = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$buffer$2d$layout$2d$helper$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BufferLayoutHelper"](this.bufferLayout);
     ...
     */ setBufferLayout(bufferLayout) {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$deep$2d$equal$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepEqual"])(nextBufferLayout, this.bufferLayout, -1)) {
            return;
        }
    ...
    /** Updates the indexed draw count override. */ setIndexCount(indexCount) {
        this.indexCount = indexCount;
        this.setNeedsRedraw('indexCount');
    }
    /** Updates the first indexed/non-indexed draw offsets. */ setDrawOffsets({ firstVertex, firstIndex }) {
    ...
    /** Set the shader inputs */ setShaderInputs(shaderInputs) {
        ...
        for (const [moduleName, module] of Object.entries(this.shaderInputs.modules)){
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$shader$2d$module$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shaderModuleHasUniforms"])(module) && !this.material?.ownsModule(moduleName)) {
                const uniformBuffer = this._uniformStore.getManagedUniformBuffer(moduleName);
                this.bindings[`${moduleName}Uniforms`] = uniformBuffer;
            }
        }
     ...
     */ setIndexBuffer(indexBuffer) {
        const resolvedIndexBuffer = indexBuffer instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$dynamic$2d$buffer$2f$dynamic$2d$buffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DynamicBuffer"] ? indexBuffer.buffer : indexBuffer;
        this.indexBuffer = resolvedIndexBuffer;
        this._dynamicIndexBufferSource = indexBuffer instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$dynamic$2d$buffer$2f$dynamic$2d$buffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DynamicBuffer"] ? {
            source: indexBuffer,
     ...
     */ setAttributes(buffers, options) {
        ...
        this.bufferLayout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$buffer$2d$layout$2d$order$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sortedBufferLayoutByShaderSourceLocations"])(this.pipeline.shaderLayout, this.bufferLayout);
        const bufferLayoutHelper = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$buffer$2d$layout$2d$helper$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BufferLayoutHelper"](this.bufferLayout);
        // Check if all buffers have a layout
        for (const [bufferName, buffer] of Object.entries(buffers)){
            const resolvedBuffer = buffer instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$dynamic$2d$buffer$2f$dynamic$2d$buffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DynamicBuffer"] ? buffer.buffer : buffer;
            ...
            for (const attributeName of attributeNames){
                ...
                if (attributeInfo) {
                    ...
                    if (bufferSlot === null) {
                        if (!disableWarnings) {
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].warn(`Model(${this.id}): Missing vertex array slot for buffer "${attributeInfo.bufferName}".`)();
                        }
                        continue; // eslint-disable-line no-continue
                    }
                    this.vertexArray.setBuffer(bufferSlot, resolvedBuffer);
                    if (buffer instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$dynamic$2d$buffer$2f$dynamic$2d$buffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DynamicBuffer"]) {
            ...
            if (!set && !disableWarnings) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].warn(`Model(${this.id}): Ignoring buffer "${resolvedBuffer.id}" for unknown attribute "${bufferName}"`)();
            }
        }
    ...
    /** Check that bindings are loaded. Returns id of first binding that is still loading. */ _areBindingsLoading() {
        for (const binding of Object.values(this.bindings)){
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$dynamic$2d$texture$2f$texture$2d$binding$2d$source$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isTextureBindingSource"])(binding) && !binding.isReady) {
                return binding.id;
            }
        }
     ...
     */ _getBindGroups(shaderLayout = this._getCurrentShaderLayout(), bindings = this._getBindings(shaderLayout)) {
        const bindGroups = shaderLayout.bindings.length ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2d$utils$2f$bind$2d$groups$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeBindingsByGroup"])(shaderLayout, bindings) : {
            0: bindings
        };
        if (!this.material) {
            return bindGroups;
    ...
    /** Get the timestamp of the latest updated bound GPU memory resource (buffer/texture). */ _getBindingsUpdateTimestamp() {
        ...
        for (const binding of Object.values(this.bindings)){
            ...
            } else if (binding instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$buffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"] || binding instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$texture$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Texture"] || binding instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$external$2d$texture$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ExternalTexture"]) {
                timestamp = Math.max(timestamp, binding.updateTimestamp);
            } else if (binding instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$dynamic$2d$buffer$2f$dynamic$2d$buffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DynamicBuffer"]) {
                timestamp = Math.max(timestamp, binding.updateTimestamp);
            } else if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$dynamic$2d$texture$2f$texture$2d$binding$2d$source$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isTextureBindingSource"])(binding)) {
                timestamp = binding.isReady ? Math.max(timestamp, binding.updateTimestamp) : Infinity;
            } else if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$dynamic$2d$buffer$2f$dynamic$2d$buffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isBufferRangeBinding"])(binding)) {
                timestamp = Math.max(timestamp, binding.buffer instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$dynamic$2d$buffer$2f$dynamic$2d$buffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DynamicBuffer"] ? binding.buffer.updateTimestamp : binding.buffer.updateTimestamp);
            }
        }
    ...
    _logFramebuffer(renderPass) {
        ...
        const framebuffer = renderPass.props.framebuffer;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$debug$2f$debug$2d$framebuffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["debugFramebuffer"])(renderPass, framebuffer, {
    ...
    /** Returns the current reflected shader layout or the pre-reflection empty layout. */ _getCurrentShaderLayout() {
        return this.pipeline?.shaderLayout || this.props.shaderLayout || {
            bindings: []
        };
    }
    _syncDynamicBuffers() {
    ...
    _syncAttachmentFormats(renderPass) {
        ...
        const nextColorAttachmentFormats = renderBundleProps.colorAttachmentFormats ?? framebuffer?.colorAttachments?.map((colorAttachment)=>asColorAttachmentFormat(colorAttachment?.texture?.format));
        const nextDepthStencilAttachmentFormat = renderBundleProps.depthStencilAttachmentFormat === false ? undefined : renderBundleProps.depthStencilAttachmentFormat ?? asDepthStencilAttachmentFormat(framebuffer?.depthStencilAttachment?.texture?.format);
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$utils$2f$deep$2d$equal$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepEqual"])(this._colorAttachmentFormats, nextColorAttachmentFormats, 1) || this._depthStencilAttachmentFormat !== nextDepthStencilAttachmentFormat) {
...
function isShaderAssemblerForLanguage(shaderAssembler, shaderLanguage) {
    if (shaderAssembler.shaderLanguage !== undefined && shaderAssembler.shaderLanguage !== shaderLanguage) {
        return false;
    }
...
function normalizeShaderPluginAttributeNames(shaderLayout, vertexInputs) {
    ...
    return {
        ...
        attributes: shaderLayout.attributes.map((attribute)=>{
            ...
            return publicName && vertexInputs[publicName] ? {
                ...attribute,
                name: publicName
            } : attribute;
        })
 ...
 */ function resolveModelBinding(bindingName, binding, shaderLayout) {
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$dynamic$2d$texture$2f$texture$2d$binding$2d$source$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isTextureBindingSource"])(binding)) {
        const bindingLayout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$dynamic$2d$texture$2f$texture$2d$binding$2d$source$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTextureBindingLayout"])(shaderLayout, bindingName, {
            fallbackGroup: 0
        });
        return bindingLayout ? binding.resolveTextureBinding(bindingLayout) : null;
    }
    if (binding instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$dynamic$2d$buffer$2f$dynamic$2d$buffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DynamicBuffer"]) {
        return binding.buffer;
    }
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$dynamic$2d$buffer$2f$dynamic$2d$buffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isBufferRangeBinding"])(binding)) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$engine$2f$dist$2f$dynamic$2d$buffer$2f$dynamic$2d$buffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveBufferRangeBinding"])(binding);
    }
    return binding;
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$buffer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/adapter/resources/buffer.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$shadertools$2f$dist$2f$lib$2f$glsl$2d$utils$2f$shader$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/shadertools/dist/lib/glsl-utils/shader-utils.js [app-client] (ecmascript)");
...
//# sourceMappingURL=node_modules_%40luma_gl_engine_dist_d1e168bb._.js.map