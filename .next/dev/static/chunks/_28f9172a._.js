...
function BuildingsWithoutGasPage() {
    ...
    const districtFilteredBuildings = districtFilter === "all" ? buildings : buildings.filter((b)=>b.district === districtFilter);
...
_s(BuildingsWithoutGasPage, "3jczBjiZTnC3uv6kZBhIqa0YifE=", false, function() {
    return [
