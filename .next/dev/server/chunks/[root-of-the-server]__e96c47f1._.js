...
"[project]/app/api/plants-stats/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function fetchFromDb() {
    ...
    try {
        ...
        return {
            ...
            byType: typesRes.rows.map((r)=>({
                    type: r.plant_type,
                    count: parseInt(r.cnt, 10)
                })),
            bySanitary: sanRes.rows.map((r)=>({
                    id: r.sanitary_id,
                    count: parseInt(r.cnt, 10)
                })),
            cachedAt: Date.now()
...
async function GET(req) {
    ...
    if (!refresh && cache && Date.now() - cache.cachedAt < TTL) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(cache, {
            headers: {
                "X-Cache": "HIT",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e96c47f1._.js.map