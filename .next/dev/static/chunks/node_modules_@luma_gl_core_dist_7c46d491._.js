...
"[project]/node_modules/@luma.gl/core/dist/shadertypes/shader-types/shader-type-decoder.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const shaderTypeDecoder = new ShaderTypeDecoder();
// TABLES
...
class Resource {
    ...
    /** Compact serialization for assertion diffs and structured debug logs. */ toJSON() {
        return this.toString();
    }
    /** props.id, for debugging. */ id;
    /** The props that this resource was created with */ props;
    /** User data object, reserved for the application */ userData = {};
    /** The device that this resource is associated with - TODO can we remove this dup? */ _device;
    /** Whether this resource has been destroyed */ destroyed = false;
    /** For resources that allocate GPU memory */ allocatedBytes = 0;
    /** Stats bucket currently holding the tracked allocation */ allocatedBytesName = null;
    ...
    /** Whether luma.gl created and owns the underlying resource handle. */ get ownsHandle() {
        return (this.props.handle === undefined || this.props.handle === null) && !this.isHandleBorrowed;
    }
    /** Whether luma.gl may only reference the opaque externally owned resource handle. */ get isHandleBorrowed() {
    ...
    /** Called by subclass to track memory allocations */ trackAllocatedMemory(bytes, name = this.getStatsName()) {
        const profiler = getCpuHotspotProfiler(this._device);
        const startTime = profiler ? getTimestamp() : 0;
    ...
    /** Called by subclass to track handle-backed memory allocations separately from owned allocations */ trackReferencedMemory(bytes, name = this.getStatsName()) {
        this.trackAllocatedMemory(bytes, `External ${name}`);
    }
    /** Called by subclass to track memory deallocations */ trackDeallocatedMemory(name = this.getStatsName()) {
    ...
    /** Called by subclass to deallocate handle-backed memory tracked via trackReferencedMemory() */ trackDeallocatedReferencedMemory(name = this.getStatsName()) {
    ...
    /** Canonical resource name used for stats buckets. */ getStatsName() {
...
class Buffer extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$resource$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Resource"] {
    ...
    /** This doesn't handle partial non-zero offset updates correctly */ _setDebugData(data, _byteOffset, byteLength) {
...
"[project]/node_modules/@luma.gl/core/dist/types.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const NativeFloat16ArrayConstructor = globalThis.Float16Array;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/types.js [app-client] (ecmascript)");
;
function getDataTypeInfo(type) {
    ...
    const [signedType, primitiveType, byteLength] = typeInfo || [
        'uint8 ',
        'i32',
        1
    ];
...
function getDataTypeFromTypedArray(arrayOrType) {
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isFloat16ArrayConstructor"])(Constructor)) {
        return 'float16';
    }
...
function getTypedArrayFromDataType(type) {
    if (type === 'float16') {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFloat16ArrayConstructor"])();
    }
    const typeInfo = NORMALIZED_TYPE_MAP[type];
    if (!typeInfo) {
...
"[project]/node_modules/@luma.gl/core/dist/shadertypes/data-types/data-type-decoder.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class DataTypeDecoder {
     ...
     */ getDataTypeInfo(type) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$data$2d$types$2f$decode$2d$data$2d$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDataTypeInfo"])(type);
    }
    /** Build a vertex format from a signed data type and a component */ getNormalizedDataType(signedDataType) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$data$2d$types$2f$decode$2d$data$2d$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getNormalizedDataType"])(signedDataType);
    }
    /** Align offset to 1, 2 or 4 elements (4, 8 or 16 bytes) */ alignTo(size, count) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$data$2d$types$2f$decode$2d$data$2d$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["alignTo"])(size, count);
    }
    /** Returns the VariableShaderType that corresponds to a typed array */ getDataType(arrayOrType) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$data$2d$types$2f$decode$2d$data$2d$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDataType"])(arrayOrType);
    }
    /** Returns the TypedArray that corresponds to a shader data type */ getTypedArrayConstructor(type) {
...
const dataTypeDecoder = new DataTypeDecoder(); //# sourceMappingURL=data-type-decoder.js.map
}),
"[project]/node_modules/@luma.gl/core/dist/shadertypes/texture-types/texture-format-table.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const TEXTURE_FORMAT_COLOR_DEPTH_TABLE = {
    // 8-bit formats
    'r8unorm': {
        webgpu: WEBGPU_CREATE_RENDER_FILTER_BLEND | WEBGPU_TIER_1_STORE
    },
    'rg8unorm': {
        webgpu: WEBGPU_CREATE_RENDER_FILTER_BLEND | WEBGPU_TIER_1_STORE
    },
    'rgb8unorm-webgl': {},
    'rgba8unorm': {
        webgpu: WEBGPU_CREATE_RENDER_FILTER_BLEND_STORE
    },
    'rgba8unorm-srgb': {
        webgpu: WEBGPU_CREATE_RENDER_FILTER_BLEND
    },
    'r8snorm': {
        render: snorm8_renderable,
        webgpu: WEBGPU_CREATE_FILTER | WEBGPU_TIER_1_RENDER_BLEND_STORE
    },
    'rg8snorm': {
        render: snorm8_renderable,
        webgpu: WEBGPU_CREATE_FILTER | WEBGPU_TIER_1_RENDER_BLEND_STORE
    ...
    'rgba8snorm': {
        render: snorm8_renderable,
        webgpu: WEBGPU_CREATE_FILTER_STORE | WEBGPU_TIER_1_RENDER_BLEND
    },
    'r8uint': {
        webgpu: WEBGPU_CREATE_RENDER | WEBGPU_TIER_1_STORE
    },
    'rg8uint': {
        webgpu: WEBGPU_CREATE_RENDER | WEBGPU_TIER_1_STORE
    },
    'rgba8uint': {
        webgpu: WEBGPU_CREATE_RENDER_STORE
    },
    'r8sint': {
        webgpu: WEBGPU_CREATE_RENDER | WEBGPU_TIER_1_STORE
    },
    ...
    'bgra8unorm-srgb': {
        webgpu: WEBGPU_CORE_CREATE_RENDER_FILTER_BLEND
    },
    'r16unorm': {
        f: norm16_webgl,
        render: norm16_renderable,
        webgpu: WEBGPU_TIER_1_ALL
    },
    'rg16unorm': {
        f: norm16_webgl,
        render: norm16_renderable,
    ...
    'rg32uint': {
        webgpu: WEBGPU_CREATE_RENDER | WEBGPU_CORE_STORE
    },
    'rgba32uint': {
        webgpu: WEBGPU_CREATE_RENDER_STORE
    },
    ...
    'rg11b10ufloat': {
        ...
        p: 1,
        render: float32_renderable,
        webgpu: WEBGPU_CREATE_FILTER | WEBGPU_TIER_1_STORE
    },
    'rgb10a2unorm': {
        channels: 'rgba',
        bitsPerChannel: [
...
"[project]/node_modules/@luma.gl/core/dist/shadertypes/texture-types/texture-format-decoder.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$texture$2d$types$2f$texture$2d$format$2d$table$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/shadertypes/texture-types/texture-format-table.js [app-client] (ecmascript)");
;
;
const RGB_FORMAT_REGEX = /^(r|rg|rgb|rgba|bgra)([0-9]*)([a-z]*)(-srgb)?(-webgl)?$/;
const COLOR_FORMAT_PREFIXES = [
    'rgb',
    'rgba',
    'bgra'
];
const DEPTH_FORMAT_PREFIXES = [
    'depth',
    'stencil'
];
...
class TextureFormatDecoder {
    ...
    /** Returns information about a texture format, e.g. attachment type, components, byte length and flags (integer, signed, normalized) */ getInfo(format) {
        return getTextureFormatInfo(format);
    }
    /**  "static" capabilities of a texture format. @note Needs to be adjusted against current device */ getCapabilities(format) {
        return getTextureFormatCapabilities(format);
    }
    /** Returns the compact WebGPU capability mask stored in the canonical format table. */ getWebGPUCapabilities(format) {
        const definition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$texture$2d$types$2f$texture$2d$format$2d$table$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTextureFormatDefinition"])(format);
    ...
    /** Computes the memory layout for a texture, in particular including row byte alignment */ computeMemoryLayout(opts) {
        return computeTextureMemoryLayout(opts);
    }
}
const textureFormatDecoder = new TextureFormatDecoder();
// HELPERS - MEMORY LAYOUT
/** Get the memory layout of a texture */ function computeTextureMemoryLayout({ format, width, height, depth, byteAlignment }) {
...
function getTextureFormatCapabilities(format) {
    const info = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$texture$2d$types$2f$texture$2d$format$2d$table$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTextureFormatDefinition"])(format);
...
function getTextureFormatInfo(format) {
    ...
    if (matches) {
        ...
        const decodedType = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$data$2d$types$2f$data$2d$type$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dataTypeDecoder"].getDataTypeInfo(dataType);
...
/** Decode texture format info from the table */ function getTextureFormatInfoUsingTable(format) {
    const info = {
        ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$texture$2d$types$2f$texture$2d$format$2d$table$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTextureFormatDefinition"])(format)
    };
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$texture$2d$types$2f$texture$2d$format$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/shadertypes/texture-types/texture-format-decoder.js [app-client] (ecmascript)");
;
;
;
;
...
class Texture extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$resource$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Resource"] {
    ...
    /** Rows are multiples of this length, padded with extra bytes if needed */ byteAlignment;
    /** The ready promise is always resolved. It is provided for type compatibility with DynamicTexture. */ ready = Promise.resolve(this);
    /** isReady is always true. It is provided for type compatibility with DynamicTexture. */ isReady = true;
    /** "Time" of last update. Monotonically increasing timestamp. TODO move to DynamicTexture? */ updateTimestamp;
    get [Symbol.toStringTag]() {
        return 'Texture';
    }
    toString() {
    ...
    /** Do not use directly. Create with device.createTexture() */ constructor(device, props, backendProps){
        ...
        if (this.props.width === undefined || this.props.height === undefined) {
            if (device.isExternalImage(props.data)) {
                ...
                this.height = 1;
                if (this.props.width === undefined || this.props.height === undefined) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].warn(`${this} created with undefined width or height. This is deprecated. Use DynamicTexture instead.`)();
                }
            }
        }
     ...
     */ computeMemoryLayout(options_ = {}) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$texture$2d$types$2f$texture$2d$format$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["textureFormatDecoder"].computeMemoryLayout({
            format,
            width,
            height,
    ...
    /** Generate mipmaps (WebGL only) */ generateMipmapsWebGL() {
     ...
     */ _getSupportedColorReadOptions(options_) {
        const options = this._normalizeTextureReadOptions(options_);
        const formatInfo = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$texture$2d$types$2f$texture$2d$format$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["textureFormatDecoder"].getInfo(this.format);
    ...
    /** Validates that a read request targets the full color aspect of the texture. */ _validateColorReadAspect(options) {
        if (options.aspect !== 'all') {
            throw new Error(`${this} color readback only supports aspect 'all'`);
        }
    }
    /** Validates that a read request targets an uncompressed color-renderable texture format. */ _validateColorReadFormat(formatInfo) {
    ...
    _normalizeTextureWriteOptions(options_) {
        ...
        options.height = Math.min(options.height, mipLevelSize.height - options.y);
        options.depthOrArrayLayers = Math.min(options.depthOrArrayLayers, mipLevelSize.depthOrArrayLayers - options.z);
        const layout = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$texture$2d$types$2f$texture$2d$format$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["textureFormatDecoder"].computeMemoryLayout({
            format: this.format,
            width: options.width,
    ...
    getAllocatedByteLength() {
        ...
        for(let mipLevel = 0; mipLevel < this.mipLevels; mipLevel++){
            ...
            allocatedByteLength += __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$texture$2d$types$2f$texture$2d$format$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["textureFormatDecoder"].computeMemoryLayout({
                format: this.format,
                width,
                height,
                depth: depthOrArrayLayers,
    ...
    /** Default options */ static defaultCopyElementImageOptions = {
        element: undefined,
        width: undefined,
        height: undefined,
        sourceX: 0,
...
"[project]/node_modules/@luma.gl/core/dist/adapter/device-defaults.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    ()=>DEVICE_DEFAULT_PROPS,
    "_getDefaultDebugValue",
    ()=>_getDefaultDebugValue
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/utils/log.js [app-client] (ecmascript)");
;
const DEVICE_DEFAULT_PROPS = {
    id: null,
...
function getDefaultDebugValue() {
    return _getDefaultDebugValue(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].get('debug'), getNodeEnv());
}
function getNodeEnv() {
...
} //# sourceMappingURL=device-defaults.js.map
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$device$2d$defaults$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/adapter/device-defaults.js [app-client] (ecmascript)");
...
class Luma {
    static defaultProps = {
        ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$device$2d$defaults$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEVICE_DEFAULT_PROPS"],
        type: 'best-available',
        adapters: undefined,
    ...
    typeof "9.4.1" !== 'undefined' ? "9.4.1" : 'running from source';
    spector;
...
"[project]/node_modules/@luma.gl/core/dist/shadertypes/vertex-types/vertex-format-decoder.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class VertexFormatDecoder {
    ...
    /** Build a vertex format from a signed data type and a component */ makeVertexFormat(signedDataType, components, normalized) {
        const dataType = normalized ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$data$2d$types$2f$data$2d$type$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dataTypeDecoder"].getNormalizedDataType(signedDataType) : signedDataType;
        switch(dataType){
    ...
    /** Get the vertex format for an attribute with TypedArray and size */ getVertexFormatFromAttribute(typedArray, size, normalized) {
        if (!size || size > 4) {
            throw new Error(`size ${size}`);
        }
        const components = size;
        const signedDataType = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$data$2d$types$2f$data$2d$type$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dataTypeDecoder"].getDataType(typedArray);
...
const vertexFormatDecoder = new VertexFormatDecoder();
function getVertexFormatDataTypeInfo(format, type) {
    try {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$data$2d$types$2f$data$2d$type$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dataTypeDecoder"].getDataTypeInfo(type);
    } catch  {
        throw new Error(`Unsupported vertex format: ${format}`);
    }
}
...
"[project]/node_modules/@luma.gl/core/dist/shadertypes/image-types/image-types.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@luma.gl/core/dist/adapter/device.js [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$texture$2d$types$2f$texture$2d$format$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/shadertypes/texture-types/texture-format-decoder.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$image$2d$types$2f$image$2d$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/shadertypes/image-types/image-types.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$texture$2d$types$2f$texture$2d$format$2d$table$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/shadertypes/texture-types/texture-format-table.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$device$2d$defaults$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/adapter/device-defaults.js [app-client] (ecmascript)");
;
;
...
class Device {
    ...
    /** Internal per-device factory storage */ _factories = {};
    ...
    /** Used by other luma.gl modules to store data on the device */ _moduleData = {};
    /** WGSL language extensions exposed by the browser. These are discovered, not requested. */ wgslLanguageFeatures = new Set();
    _textureCaps = {};
    /** Internal timestamp query set used when GPU timing collection is enabled for this device. */ _debugGPUTimeQuery = null;
    constructor(props){
        this.props = {
            ...Device.defaultProps,
            ...props
    ...
    getVertexFormatInfo(format) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$vertex$2d$types$2f$vertex$2d$format$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vertexFormatDecoder"].getVertexFormatInfo(format);
    }
    ...
    /** Returns information about a texture format, such as data type, channels, bits per channel, compression etc */ getTextureFormatInfo(format) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$texture$2d$types$2f$texture$2d$format$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["textureFormatDecoder"].getInfo(format);
    }
    ...
    /** Check if data is an external image */ isExternalImage(data) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$image$2d$types$2f$image$2d$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isExternalImage"])(data);
    }
    /** Get the size of an external image */ getExternalImageSize(data) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$image$2d$types$2f$image$2d$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getExternalImageSize"])(data);
    }
    ...
    /** Check if a specific texture format is GPU compressed */ isTextureFormatCompressed(format) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$texture$2d$types$2f$texture$2d$format$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["textureFormatDecoder"].isCompressed(format);
    }
    /** Returns the compressed texture formats that can be created and sampled on this device */ getSupportedCompressedTextureFormats() {
        const supportedFormats = [];
        for (const format of Object.keys((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$texture$2d$types$2f$texture$2d$format$2d$table$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTextureFormatTable"])())){
     ...
     */ reportError(error, context, ...args) {
        ...
        if (!isHandled) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].error(this.type === 'webgl' ? '%cWebGL' : '%cWebGPU', 'color: white; background: red; padding: 2px 6px; border-radius: 3px;', error.message, ...logArguments);
        }
        return ()=>{};
    }
...
or create a device with the 'debug: true' prop.`;
    ...
    /** Create a fence sync object */ createFence() {
    ...
    /** Internal helper for creating a shareable WebGL render-pipeline implementation. */ _createSharedRenderPipelineWebGL(_props) {
        throw new Error('_createSharedRenderPipelineWebGL() not implemented');
    }
    /** Internal WebGPU-only helper for retrieving the native bind-group layout for a pipeline group. */ _createBindGroupLayoutWebGPU(_pipeline, _group) {
        throw new Error('_createBindGroupLayoutWebGPU() not implemented');
    }
    /** Internal WebGPU-only helper for creating a native bind group. */ _createBindGroupWebGPU(_bindGroupLayout, _shaderLayout, _bindings, _group, _label) {
    ...
    /** Internal helper that returns `true` when device-managed GPU timing is currently active. */ _isDebugGPUTimeEnabled() {
    ...
    _getDeviceTextureFormatCapabilities(format) {
        const genericCapabilities = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$texture$2d$types$2f$texture$2d$format$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["textureFormatDecoder"].getCapabilities(format);
...
"[project]/node_modules/@luma.gl/core/dist/adapter/canvas-observer.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class CanvasObserver {
    /** Observer options and event callbacks. */ props;
    _resizeObserver;
    ...
    _started = false;
    /** Whether the DOM observers and polling loops have been started. */ get started() {
    ...
    /** Starts DOM observation and optional position polling. */ start() {
    ...
    /** Stops DOM observation, media-query listeners, and position polling. */ stop() {
        if (!this._started) {
            return;
        }
        this._started = false;
    ...
    /** Reports the current device pixel ratio and arms the media query for its next change. */ _refreshDevicePixelRatio() {
        if (!this._started) {
            return;
        }
...
"[project]/node_modules/@luma.gl/core/dist/utils/assert.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

// luma.gl
// SPDX-License-Identifier: MIT
// SPDX-FileCopyrightText: Copyright (c) vis.gl contributors
/** Throws if condition is true and narrows type */ __turbopack_context__.s([
    "assert",
    ()=>assert,
    "assertDefined",
    ()=>assertDefined
...
"[project]/node_modules/@luma.gl/core/dist/adapter/canvas-surface.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$probe$2e$gl$2f$env$2f$dist$2f$lib$2f$is$2d$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@probe.gl/env/dist/lib/is-browser.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$canvas$2d$observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/adapter/canvas-observer.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$uid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/utils/uid.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$assert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/utils/assert.js [app-client] (ecmascript)");
;
;
;
;
...
class CanvasSurface {
    ...
    /** Resolves when the canvas is initialized, i.e. when the ResizeObserver has updated the pixel size */ _initializedResolvers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$promise$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["withResolvers"])();
    _canvasObserver;
    /** Position of the canvas in the document, updated by a timer */ _position = [
        0,
        0
    ];
    /** Whether this canvas context has been destroyed */ destroyed = false;
    /** Whether the drawing buffer size needs to be resized (deferred resizing to avoid flicker) */ _needsDrawingBufferResize = true;
    /** Drawing buffer size the device was last configured for; subclass constructors configure at the initial canvas size */ _configuredDrawingBufferSize = [
        0,
        0
    ];
    toString() {
    ...
    constructor(props){
        ...
        this._canvasObserver = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$canvas$2d$observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CanvasObserver"]({
    ...
    /** Returns a framebuffer with properly resized current 'swap chain' textures */ getCurrentFramebuffer(options) {
    ...
    getDevicePixelRatio() {
        const devicePixelRatio1 = typeof window !== 'undefined' && window.devicePixelRatio;
        return devicePixelRatio1 || 1;
    }
    ...
    /** @deprecated Use the current drawing buffer size for projection setup. */ getAspect() {
        const [width, height] = this.getDrawingBufferSize();
    ...
    _handleResize(entries) {
        ...
        const contentBoxSize = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$assert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assertDefined"])(entry.contentBoxSize?.[0]);
    ...
    _updateDrawingBufferSize() {
        if (this.props.autoResize) {
            if (typeof this.props.useDevicePixels === 'number') {
                const devicePixelRatio1 = this.props.useDevicePixels;
                this.setDrawingBufferSize(this.cssWidth * devicePixelRatio1, this.cssHeight * devicePixelRatio1);
    ...
    _getDevicePixelSizeFromCSSSize(cssWidth, cssHeight) {
        const devicePixelRatio1 = this.getDevicePixelRatio();
        return {
            devicePixelWidth: Math.floor(cssWidth * devicePixelRatio1),
            devicePixelHeight: Math.floor(cssHeight * devicePixelRatio1)
        };
    }
    ...
    _resizeDrawingBufferIfNeeded() {
        if (this._needsDrawingBufferResize) {
            ...
            const canvasSizeChanged = this.drawingBufferWidth !== this.canvas.width || this.drawingBufferHeight !== this.canvas.height;
            ...
            const configuredSizeChanged = this.drawingBufferWidth !== configuredWidth || this.drawingBufferHeight !== configuredHeight;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$canvas$2d$surface$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/adapter/canvas-surface.js [app-client] (ecmascript)");
;
class CanvasContext extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$canvas$2d$surface$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CanvasSurface"] {
    static defaultProps = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$canvas$2d$surface$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CanvasSurface"].defaultProps;
...
"[project]/node_modules/@luma.gl/core/dist/adapter/presentation-context.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$canvas$2d$surface$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/adapter/canvas-surface.js [app-client] (ecmascript)");
;
class PresentationContext extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$canvas$2d$surface$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CanvasSurface"] {
...
class Shader extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$resource$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Resource"] {
    ...
    /** In browser logging of errors */ async debugShader() {
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].warn(`Shader ${this.id}: failed to fetch compilation info during debug logging`, error)();
        }
    }
    // PRIVATE
    /**
     ...
     */ _displayShaderLog(messages, shaderId) {
        ...
        const htmlLog = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2d$utils$2f$format$2d$compiler$2d$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCompilerLog"])(messages, this.source, {
            showSourceCode: 'all',
            html: true
        });
...
class RenderPipeline extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$resource$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Resource"] {
    ...
    /** Optional shared backend implementation */ sharedRenderPipeline = null;
    /** Whether shader or pipeline compilation/linking is still in progress */ get isPending() {
        return this.linkStatus === 'pending' || this.vs.compilationStatus === 'pending' || this.fs?.compilationStatus === 'pending';
    }
    /** Whether shader or pipeline compilation/linking has failed */ get isErrored() {
...
"[project]/node_modules/@luma.gl/core/dist/adapter-utils/bind-groups.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getShaderLayoutBinding(shaderLayout, bindingName, options) {
    ...
    if (!bindingLayout && !options?.ignoreWarnings) {
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].warn(`Binding ${bindingName} not set: Not found in shader layout.`)();
    }
...
function normalizeBindingsByGroup(shaderLayout, bindingsOrBindGroups) {
    ...
    if (areBindingsGrouped(bindingsOrBindGroups)) {
        ...
        return Object.fromEntries(Object.entries(bindGroups).map(([group, bindings])=>[
                Number(group),
                {
                    ...bindings
                }
...
"[project]/node_modules/@luma.gl/core/dist/shadertypes/shader-types/shader-block-layout.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function makeShaderBlockLayout(uniformTypes, options = {}) {
    ...
    size = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$data$2d$types$2f$decode$2d$data$2d$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["alignTo"])(size, getTypeAlignment(copiedUniformTypes, layout));
    return {
        layout,
        byteLength: size * 4,
...
function getLeafLayoutInfo(type, layout) {
    const resolvedType = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$shader$2d$types$2f$shader$2d$type$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveVariableShaderTypeAlias"])(type);
    const decodedType = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$shader$2d$types$2f$shader$2d$type$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getVariableShaderTypeInfo"])(resolvedType);
 ...
 */ function addToLayout(fields, name, type, offset, layout) {
    if (typeof type === 'string') {
        ...
        const alignedOffset = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$data$2d$types$2f$decode$2d$data$2d$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["alignTo"])(offset, info.alignment);
        fields[name] = {
    ...
    if (Array.isArray(type)) {
        ...
        const arrayOffset = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$data$2d$types$2f$decode$2d$data$2d$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["alignTo"])(offset, getTypeAlignment(type, layout));
    ...
    if (isCompositeShaderTypeStruct(type)) {
        ...
        let structOffset = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$data$2d$types$2f$decode$2d$data$2d$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["alignTo"])(offset, structAlignment);
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$data$2d$types$2f$decode$2d$data$2d$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["alignTo"])(structOffset, structAlignment);
    }
 ...
 */ function getTypeSize(type, layout) {
    ...
    for (const memberType of Object.values(type)){
        ...
        size = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$data$2d$types$2f$decode$2d$data$2d$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["alignTo"])(size, getTypeAlignment(compositeMemberType, layout));
        size += getTypeSize(compositeMemberType, layout);
    }
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$data$2d$types$2f$decode$2d$data$2d$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["alignTo"])(size, getTypeAlignment(type, layout));
}
/**
 ...
 */ function getArrayLikeStride(size, alignment, layout) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$data$2d$types$2f$decode$2d$data$2d$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["alignTo"])(size, uses16ByteArrayAlignment(layout) ? 4 : alignment);
}
/**
 * Returns the stride of a matrix column in 32-bit words.
 */ function getMatrixColumnStride(size, alignment, layout) {
    return layout === 'std140' ? 4 : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$data$2d$types$2f$decode$2d$data$2d$types$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["alignTo"])(size, alignment);
}
/**
...
"[project]/node_modules/@luma.gl/core/dist/adapter/resources/shared-render-pipeline.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$resource$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/adapter/resources/resource.js [app-client] (ecmascript)");
;
class SharedRenderPipeline extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$resource$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Resource"] {
    get [Symbol.toStringTag]() {
...
class CommandEncoder extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$resource$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Resource"] {
    ...
    /** Returns the number of query slots consumed by automatic pass profiling on this encoder. */ getTimeProfilingSlotCount() {
        return this._timeProfilingSlotCount;
    }
    getTimeProfilingQuerySet() {
        return this._timeProfilingQuerySet;
    }
    /** Internal helper for auto-assigning timestamp slots to render/compute passes on this encoder. */ _applyTimeProfilingToPassProps(props) {
...
class RenderPass extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$resource$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Resource"] {
    ...
    constructor(device, props, defaultProps = RenderPass.defaultProps){
...
class VertexArray extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$resource$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Resource"] {
    ...
    /** Buffers or constants indexed by backend-defined buffer slot or attribute location. */ attributes;
    /**
    ...
    /** Returns the backend-defined slot for a logical buffer name, if known. */ getBufferSlot(bufferName) {
        return null;
    }
    /** Returns a draw-blocking validation error, or null if this vertex array can be drawn. */ getDrawValidationError() {
        return null;
    }
    // DEPRECATED METHODS
...
"[project]/node_modules/@luma.gl/core/dist/adapter-utils/buffer-layout-utils.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getShaderAttributeLocationMap(shaderLayout) {
    return Object.fromEntries(shaderLayout.attributes.map((attribute)=>[
            attribute.name,
            attribute.location
        ]));
}
...
function resolveLogicalAttributeMappings(shaderLayout, bufferLayout, options) {
    ...
    return shaderLayout.attributes.map((attribute)=>{
        ...
        if (!bufferMapping && options?.warnOnMissingBufferLayout) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].warn(`layout for attribute "${attribute.name}" not present in buffer layout`)();
        }
        const attributeTypeInfo = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$shader$2d$types$2f$shader$2d$type$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shaderTypeDecoder"].getAttributeShaderTypeInfo(attribute.type);
        const vertexFormat = bufferMapping?.vertexFormat || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$vertex$2d$types$2f$vertex$2d$format$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vertexFormatDecoder"].getCompatibleVertexFormat(attributeTypeInfo);
        return {
            ...
            byteStride: bufferMapping?.byteStride ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$vertex$2d$types$2f$vertex$2d$format$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vertexFormatDecoder"].getVertexFormatInfo(vertexFormat).byteLength,
 ...
 */ function validateBufferLayouts(bufferLayouts) {
    for (const bufferLayout of bufferLayouts){
        if (bufferLayout.attributes && bufferLayout.format || !bufferLayout.attributes && !bufferLayout.format) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].warn(`BufferLayout ${bufferLayout.name} must have either 'attributes' or 'format' field`)();
        }
    }
}
/**
 ...
 */ function getBufferLayoutByteStride(bufferLayout) {
    ...
    if (bufferLayout.attributes) {
        ...
        for (const attributeMapping of bufferLayout.attributes){
            packedByteStride += __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$vertex$2d$types$2f$vertex$2d$format$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vertexFormatDecoder"].getVertexFormatInfo(attributeMapping.format).byteLength;
        }
        return packedByteStride;
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$vertex$2d$types$2f$vertex$2d$format$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vertexFormatDecoder"].getVertexFormatInfo(bufferLayout.format).byteLength;
} //# sourceMappingURL=buffer-layout-utils.js.map
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$shader$2d$types$2f$shader$2d$type$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/shadertypes/shader-types/shader-type-decoder.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$vertex$2d$types$2f$vertex$2d$format$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/shadertypes/vertex-types/vertex-format-decoder.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2d$utils$2f$buffer$2d$layout$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/adapter-utils/buffer-layout-utils.js [app-client] (ecmascript)");
;
;
;
;
function getAttributeInfosFromLayouts(shaderLayout, bufferLayout) {
    ...
    const logicalMappings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2d$utils$2f$buffer$2d$layout$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveLogicalAttributeMappings"])(shaderLayout, bufferLayout, {
 ...
 */ function getAttributeInfoFromLogicalMapping(shaderLayout, logicalMapping) {
    ...
    const attributeTypeInfo = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$shader$2d$types$2f$shader$2d$type$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shaderTypeDecoder"].getAttributeShaderTypeInfo(shaderDeclaration.type);
    const vertexFormat = logicalMapping.vertexFormat;
    const vertexFormatInfo = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$vertex$2d$types$2f$vertex$2d$format$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vertexFormatDecoder"].getVertexFormatInfo(vertexFormat);
    return {
...
function getAttributeFromShaderLayout(shaderLayout, name) {
    ...
    if (!attribute) {
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].warn(`shader layout attribute "${name}" not present in shader`)();
    }
...
"[project]/node_modules/@luma.gl/core/dist/adapter/resources/fence.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$resource$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/adapter/resources/resource.js [app-client] (ecmascript)");
;
class Fence extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$resource$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Resource"] {
    static defaultProps = {
        ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$resource$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Resource"].defaultProps
    };
    get [Symbol.toStringTag]() {
...
"[project]/node_modules/@luma.gl/core/dist/factories/pipeline-factory.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$compute$2d$pipeline$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/adapter/resources/compute-pipeline.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$render$2d$pipeline$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/adapter/resources/render-pipeline.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/utils/log.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$uid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/utils/uid.js [app-client] (ecmascript)");
;
;
...
class PipelineFactory {
     ...
     */ /** Return a RenderPipeline matching supplied props. Reuses an equivalent pipeline if already created. */ createRenderPipeline(props) {
        ...
        if (!pipeline) {
            ...
            pipeline = this.device.createRenderPipeline({
                ...allProps,
                id: allProps.id ? `${allProps.id}-cached` : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$uid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uid"])('unnamed-cached'),
            ...
            if (this.device.props.debugFactories) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].log(3, `${this}: ${pipeline} created, count=${cache[hash].useCount}`)();
            }
        } else {
            cache[hash].useCount++;
            if (this.device.props.debugFactories) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].log(3, `${this}: ${cache[hash].resource} reused, count=${cache[hash].useCount}, (id=${props.id})`)();
            }
        }
        return pipeline;
    }
    ...
    release(pipeline) {
        ...
        if (cache[hash].useCount === 0) {
            ...
            if (this.device.props.debugFactories) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].log(3, `${this}: ${pipeline} released and destroyed`)();
            }
        } else if (cache[hash].useCount < 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].error(`${this}: ${pipeline} released, useCount < 0, resetting`)();
            cache[hash].useCount = 0;
        } else if (this.device.props.debugFactories) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].log(3, `${this}: ${pipeline} released, count=${cache[hash].useCount}`)();
        }
    }
    ...
    // PRIVATE
    /** Destroy a cached pipeline, removing it from the cache if configured to do so. */ _destroyPipeline(pipeline) {
        const cache = this._getCache(pipeline);
        ...
        pipeline.destroy();
        if (pipeline instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$render$2d$pipeline$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderPipeline"]) {
    ...
    /** Get the appropriate cache for the type of pipeline */ _getCache(pipeline) {
        let cache;
        if (pipeline instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$compute$2d$pipeline$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ComputePipeline"]) {
...
"[project]/node_modules/@luma.gl/core/dist/factories/shader-factory.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$shader$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/adapter/resources/shader.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/utils/log.js [app-client] (ecmascript)");
;
;
class ShaderFactory {
    ...
    /** Requests a {@link Shader} from the cache, creating a new Shader only if necessary. */ createShader(props) {
        ...
        if (!cacheEntry) {
            ...
            if (this.device.props.debugFactories) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].log(3, `${this}: Created new shader ${resource.id}`)();
            }
        } else {
            cacheEntry.useCount++;
            if (this.device.props.debugFactories) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].log(3, `${this}: Reusing shader ${cacheEntry.resource.id} count=${cacheEntry.useCount}`)();
            }
        }
        ...
        if (cacheEntry) {
            ...
            if (cacheEntry.useCount === 0) {
                if (this.device.props._destroyShaders) {
                    ...
                    if (this.device.props.debugFactories) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].log(3, `${this}: Releasing shader ${shader.id}, destroyed`)();
                    }
                }
            } else if (cacheEntry.useCount < 0) {
                throw new Error(`ShaderFactory: Shader ${shader.id} released too many times`);
            } else if (this.device.props.debugFactories) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].log(3, `${this}: Releasing shader ${shader.id} count=${cacheEntry.useCount}`)();
            }
        }
    }
    // PRIVATE
...
function arrayEqual(a, b, limit = 16) {
    ...
    const arrayA = a;
    const arrayB = b;
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$is$2d$array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNumberArray"])(arrayA) || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$is$2d$array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNumberArray"])(arrayB)) {
        return false;
    }
...
class UniformBlock {
    ...
    /** Set a single uniform. Returns `true` if the value changed. */ _setUniform(key, value) {
...
"[project]/node_modules/@luma.gl/core/dist/portable/shader-block-writer.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$is$2d$array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/utils/is-array.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/utils/log.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$shader$2d$types$2f$shader$2d$block$2d$layout$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/shadertypes/shader-types/shader-block-layout.js [app-client] (ecmascript)");
;
;
;
;
class ShaderBlockWriter {
    /** Layout metadata used to flatten and serialize values. */ layout;
    /**
     ...
     */ getData(uniformValues) {
        const buffer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$array$2d$utils$2d$flat$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getScratchArrayBuffer"])(this.layout.byteLength);
     ...
     */ _flattenCompositeValue(flattenedUniformValues, baseName, uniformType, value) {
        ...
        if (Array.isArray(uniformType)) {
            ...
            if (typeof elementType === 'string' && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$is$2d$array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNumberArray"])(value)) {
                this._flattenPackedArray(flattenedUniformValues, baseName, elementType, length, value);
                return;
            }
            if (!Array.isArray(value)) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].warn(`Unsupported uniform array value for ${baseName}:`, value)();
                return;
            }
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$shader$2d$types$2f$shader$2d$block$2d$layout$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isCompositeShaderTypeStruct"])(uniformType) && isCompositeUniformObject(value)) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].warn(`Unsupported uniform value for ${baseName}:`, value)();
    }
    /**
     ...
     */ _flattenPackedArray(flattenedUniformValues, baseName, elementType, length, value) {
        ...
        const elementLayout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$shader$2d$types$2f$shader$2d$block$2d$layout$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLeafLayoutInfo"])(elementType, this.layout.layout);
     ...
     */ _writeLeafValue(typedArrays, name, value) {
        const entry = this.layout.fields[name];
        if (!entry) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$utils$2f$log$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].warn(`Uniform ${name} not found in layout`)();
            return;
        }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$portable$2f$shader$2d$block$2d$writer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/portable/shader-block-writer.js [app-client] (ecmascript)");
;
;
;
;
...
class UniformStore {
    /** Device used to infer layout and allocate buffers. */ device;
    /** Stores the uniform values for each uniform block */ uniformBlocks = new Map();
    /** Flattened layout metadata for each block. */ shaderBlockLayouts = new Map();
    /** Serializers for block-backed uniform data. */ shaderBlockWriters = new Map();
     ...
     */ constructor(device, blocks){
        ...
        for (const [bufferName, block] of Object.entries(blocks)){
            ...
            const shaderBlockLayout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$shadertypes$2f$shader$2d$types$2f$shader$2d$block$2d$layout$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["makeShaderBlockLayout"])(block.uniformTypes ?? {}, {
                layout: block.layout ?? getDefaultUniformBufferLayout(device)
            });
            const shaderBlockWriter = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$portable$2f$shader$2d$block$2d$writer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShaderBlockWriter"](shaderBlockLayout);
    ...
    /** Returns the managed uniform buffer for the named block. */ getManagedUniformBuffer(uniformBufferName) {
...
"[project]/node_modules/@luma.gl/core/dist/adapter/resources/external-texture.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$resource$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@luma.gl/core/dist/adapter/resources/resource.js [app-client] (ecmascript)");
;
class ExternalTexture extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$resource$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Resource"] {
    /** Width in pixels for this concrete sampled binding. */ width;
    /** Height in pixels for this concrete sampled binding. */ height;
    /** Device timestamp of this external binding acquisition. */ updateTimestamp;
    /** Resource label used by debug output. */ get [Symbol.toStringTag]() {
    ...
    /** Default resolved properties used by concrete external texture bindings. */ static defaultProps = {
        ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$luma$2e$gl$2f$core$2f$dist$2f$adapter$2f$resources$2f$resource$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Resource"].defaultProps,
        source: undefined,
        width: 0,
        height: 0,
...
//# sourceMappingURL=node_modules_%40luma_gl_core_dist_7c46d491._.js.map