...
"[project]/app/buildings-without-gas/buildings-analytics.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BuildingsAnalytics({ buildings }) {
    ...
    const analytics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BuildingsAnalytics.useMemo[analytics]": ()=>{
            if (!buildings.length) return null;
            const total = buildings.length;
            const inAlmaty = buildings.filter({
                "BuildingsAnalytics.useMemo[analytics]": (b)=>!b.is_not_in_almaty
            }["BuildingsAnalytics.useMemo[analytics]"]).length;
            const outsideAlmaty = buildings.filter({
                "BuildingsAnalytics.useMemo[analytics]": (b)=>b.is_not_in_almaty
            }["BuildingsAnalytics.useMemo[analytics]"]).length;
            const getGasStatus = {
                "BuildingsAnalytics.useMemo[analytics].getGasStatus": (b)=>b.gas_connected ?? b.has_gas
            }["BuildingsAnalytics.useMemo[analytics].getGasStatus"];
            const withGas = buildings.filter({
                "BuildingsAnalytics.useMemo[analytics]": (b)=>getGasStatus(b) === true
            }["BuildingsAnalytics.useMemo[analytics]"]).length;
            const withoutGas = buildings.filter({
                "BuildingsAnalytics.useMemo[analytics]": (b)=>getGasStatus(b) === false
            }["BuildingsAnalytics.useMemo[analytics]"]).length;
            const unknownGas = buildings.filter({
                "BuildingsAnalytics.useMemo[analytics]": (b)=>getGasStatus(b) == null
            }["BuildingsAnalytics.useMemo[analytics]"]).length;
            const getCategory = {
                "BuildingsAnalytics.useMemo[analytics].getCategory": (b)=>{
                    const cat = (b.category || "").toLowerCase();
                    if (cat.includes("ижс") || cat.includes("izhs")) return "izhs";
                    if (cat.includes("сусн") || cat.includes("susn")) return "susn";
                    return "general";
                }
            }["BuildingsAnalytics.useMemo[analytics].getCategory"];
            const general = buildings.filter({
                "BuildingsAnalytics.useMemo[analytics]": (b)=>getCategory(b) === "general"
            }["BuildingsAnalytics.useMemo[analytics]"]).length;
            const izhs = buildings.filter({
                "BuildingsAnalytics.useMemo[analytics]": (b)=>getCategory(b) === "izhs"
            }["BuildingsAnalytics.useMemo[analytics]"]).length;
            const susn = buildings.filter({
                "BuildingsAnalytics.useMemo[analytics]": (b)=>getCategory(b) === "susn"
            }["BuildingsAnalytics.useMemo[analytics]"]).length;
            const canConnect = buildings.filter({
                "BuildingsAnalytics.useMemo[analytics]": (b)=>b.gas_connection_available === true
            }["BuildingsAnalytics.useMemo[analytics]"]).length;
            const notLegalized = buildings.filter({
                "BuildingsAnalytics.useMemo[analytics]": (b)=>b.property_not_legalized === true
            }["BuildingsAnalytics.useMemo[analytics]"]).length;
            const notEligible = buildings.filter({
                "BuildingsAnalytics.useMemo[analytics]": (b)=>b.property_not_eligible_for_gas_connection === true
            }["BuildingsAnalytics.useMemo[analytics]"]).length;
            const noFunds = buildings.filter({
                "BuildingsAnalytics.useMemo[analytics]": (b)=>b.no_funds_for_gas_connection === true
            }["BuildingsAnalytics.useMemo[analytics]"]).length;
            const seasonalUnused = buildings.filter({
                "BuildingsAnalytics.useMemo[analytics]": (b)=>b.is_seasonal_or_unused === true
            }["BuildingsAnalytics.useMemo[analytics]"]).length;
            const withBathhouse = buildings.filter({
                "BuildingsAnalytics.useMemo[analytics]": (b)=>b.has_private_bathhouse === true
            }["BuildingsAnalytics.useMemo[analytics]"]).length;
            const byDistrict = Object.entries(DISTRICT_LABELS).map({
                "BuildingsAnalytics.useMemo[analytics].byDistrict": ([id, name], i)=>{
                    const db = buildings.filter({
                        "BuildingsAnalytics.useMemo[analytics].byDistrict.db": (b)=>b.district_id === parseInt(id)
                    }["BuildingsAnalytics.useMemo[analytics].byDistrict.db"]);
                    return {
                        name,
                        total: db.length,
                        withGas: db.filter({
                            "BuildingsAnalytics.useMemo[analytics].byDistrict": (b)=>getGasStatus(b) === true
                        }["BuildingsAnalytics.useMemo[analytics].byDistrict"]).length,
                        withoutGas: db.filter({
                            "BuildingsAnalytics.useMemo[analytics].byDistrict": (b)=>getGasStatus(b) === false
                        }["BuildingsAnalytics.useMemo[analytics].byDistrict"]).length,
                        izhs: db.filter({
                            "BuildingsAnalytics.useMemo[analytics].byDistrict": (b)=>getCategory(b) === "izhs"
                        }["BuildingsAnalytics.useMemo[analytics].byDistrict"]).length,
                        susn: db.filter({
                            "BuildingsAnalytics.useMemo[analytics].byDistrict": (b)=>getCategory(b) === "susn"
                        }["BuildingsAnalytics.useMemo[analytics].byDistrict"]).length,
                        pct: total > 0 ? parseFloat((db.length / total * 100).toFixed(1)) : 0,
                        color: DISTRICT_COLORS[i]
                    };
                }
            }["BuildingsAnalytics.useMemo[analytics].byDistrict"]).filter({
                "BuildingsAnalytics.useMemo[analytics].byDistrict": (d)=>d.total > 0
            }["BuildingsAnalytics.useMemo[analytics].byDistrict"]).sort({
                "BuildingsAnalytics.useMemo[analytics].byDistrict": (a, b)=>b.total - a.total
            }["BuildingsAnalytics.useMemo[analytics].byDistrict"]);
            const buildingTypeCounts = {};
            buildings.forEach({
                "BuildingsAnalytics.useMemo[analytics]": (b)=>{
                    const t = b.building_type || b.building_type_raw || "Не указано";
                    buildingTypeCounts[t] = (buildingTypeCounts[t] || 0) + 1;
                }
            }["BuildingsAnalytics.useMemo[analytics]"]);
            const allBuildingTypes = Object.entries(buildingTypeCounts).sort({
                "BuildingsAnalytics.useMemo[analytics].allBuildingTypes": (a, b)=>b[1] - a[1]
            }["BuildingsAnalytics.useMemo[analytics].allBuildingTypes"]);
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: gasDonutData.map((c)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex flex-col gap-2 text-xs",
                                            children: categoryDonutData.map((c)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "flex items-center gap-2",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "h-2.5 w-2.5 flex-shrink-0 rounded-full",
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "grid grid-cols-1 gap-4 lg:grid-cols-2",
                    children: [
                        reasonsData.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "rounded-xl border border-border bg-card p-4",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                    className: "mb-3 text-sm font-semibold",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                        children: analytics.byDistrict.map((d)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                className: "border-b border-border/40 hover:bg-muted/30",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "py-1.5 pr-2",
...
_s(BuildingsAnalytics, "Q7AhsL3j2gcrWRU5TlKNAs9L+YU=");
_c1 = BuildingsAnalytics;
var _c, _c1;
__turbopack_context__.k.register(_c, "KpiCard");
__turbopack_context__.k.register(_c1, "BuildingsAnalytics");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$buildings$2d$without$2d$gas$2f$buildings$2d$analytics$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/buildings-without-gas/buildings-analytics.tsx [app-client] (ecmascript)");
...
const BuildingsMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/components/buildings-map-mapbox.tsx [app-client] (ecmascript, next/dynamic entry, async loader)"), {
    loadableGenerated: {
        modules: [
                ...
                children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: showSidePanel && selectedBuilding ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex items-center gap-2",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    onClick: ()=>{
                                    ...
                                    showSidePanel && selectedBuilding && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            (selectedBuilding.is_not_in_almaty || selectedBuilding.is_seasonal_or_unused) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    selectedBuilding.is_not_in_almaty && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    ...
                                                    selectedBuilding.is_seasonal_or_unused && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            ...
                                            (selectedBuilding.fio || selectedBuilding.mobile_home_number) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    selectedBuilding.fio && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    selectedBuilding.mobile_home_number && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            selectedBuilding.gas_id && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                className: "font-mono text-[9px] text-muted-foreground",
                                                                children: [
                                                                    "Gas: ",
                                    ...
                                    !showSidePanel && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            activeTab === "analytics" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$buildings$2d$without$2d$gas$2f$buildings$2d$analytics$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BuildingsAnalytics"], {
                                buildings: buildings
                            }, void 0, false, {
                                fileName: "[project]/app/buildings-without-gas/page.tsx",
                                lineNumber: 2014,
...
_s(BuildingsWithoutGasPage, "Q+xJ2pUnKgdtI8P2TJbu77DUQuc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$themes$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"],
...
//# sourceMappingURL=_dca4845c._.js.map